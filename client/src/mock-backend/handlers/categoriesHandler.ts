...
export const categoriesHandlers = [
  ...
  http.post(
    url(api.category.addItem(0, 0)).replace('/0/add-item/0', '/:categoryId/add-item/:itemId'),
    async ({ params }) => {
  ...
  http.post(
    url(api.category.removeItem(0, 0)).replace('/0/remove-item/0', '/:categoryId/remove-item/:itemId'),
    async ({ params }) => {
      const categoryId = Number(params.categoryId)
      const itemId = Number(params.itemId)
  ...
  http.post(
    url(api.category.addSubcategory(0, 0)).replace('/0/add-subcategory/0', '/:parentId/add-subcategory/:childId'),
    async ({ params }) => {
  ...
  http.post(
    url(api.category.removeSubcategory(0, 0)).replace('/0/remove-subcategory/0', '/:parentId/remove-subcategory/:childId'),
    async ({ params }) => {
      const parentId = Number(params.parentId)
      const childId = Number(params.childId)
